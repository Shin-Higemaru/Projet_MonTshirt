    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <div class="table-responsive">
            <div class="jumbotron">
                ...
                <p>{{$order->adresse->adresse}} <br> {{$order->adresse->adresse2}} <br> {{$order->adresse->code_postal}} - {{$order->adresse->ville}}</p>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <strong>{{$product->nom}}
                        {{$product->pivot->size}} </strong> <br>
                    </td>
                    <td>{{$product->pivot->qty}}</td>
                    <td>
                        {{number_format($product->pivot->prix_unitaire_ttc,2)}}
                    € TTC</td>
                ...
                <tr>
                    <td colspan="3"></td>
                    <td>TVA(20%)</td>
                    <td class="text-right">{{number_format($order->tva,2)}} €</td>
                </tr>
                <tr>
                    <td colspan="3"></td>
                    <td>TOTAL TTC:</td>
